        ...
        <div className="relative flex min-h-screen items-center justify-center px-4 py-12">
            ...
            >
                ...
                <div className="flex items-center justify-center mb-6">
                    <Image src="/Branding/BrandLogicIcon-UltraBlur.png" alt="Brand Logic" width={75} height={75} />
                </div>
                ...
                <form className="space-y-5">
                    ...
                    {searchParams.message && (
                        <div className="text-sm font-medium text-red-400 bg-red-900/20 p-4 rounded-2xl border border-red-500/20 text-center">
                            {searchParams.message}
                        </div>
                    )}
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm text-white/40">
                        ...
                        <Link href="/signup" className="text-white hover:text-gold transition-colors underline underline-offset-4">
                            Sign up
                        </Link>
                    </p>
                </div>
